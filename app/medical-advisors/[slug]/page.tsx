            ...
            <section className="py-10 md:py-12">
                <div className="container mx-auto px-4 md:px-0">
                    <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                        ...
                        <div className="lg:col-span-1 lg:sticky lg:top-8 min-h-screen self-start space-y-6 hidden lg:block">
                                    ...
                                    {doctor.experience && (
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="description text-gray-600">{doctor.experience}</p>
                                            </div>
                                        </div>
                                    )}
                        ...
                        <div className="lg:col-span-2 space-y-6 md:space-y-8">
                            ...
                            {/* About */}
                            {doctor.about && (
                                <Card className="border-gray-100 p-6 shadow-none ring-1 ring-gray-100 transition-all duration-300 hover:shadow-sm hover:ring-primary/50">
                                    <div className="flex-1 text-center md:text-left">
                                        ...
                                        {/* Quick Stats */}
                                        <div className="flex flex-wrap justify-center md:justify-start gap-6 mb-4 description">
                                            {doctor.experience && (
