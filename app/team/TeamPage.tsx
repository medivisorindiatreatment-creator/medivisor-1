                            ...
                            <div className="flex overflow-x-auto whitespace-nowrap justify-right md:justify-center gap-3 mb-5 py-2">
                                {featuredMembers.map((member, index) => (
                                    <button
                                        ...
                                        className={`px-4 py-2 sm:px-6 sm:py-3 rounded-full text-sm sm:text-base font-semibold transition-all duration-300 transform flex-shrink-0 ${activeTab === index
